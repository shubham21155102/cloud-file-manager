...
// app.post('/upload',upload.single("fileP"),async (req, res) => {
...
//     }
// });
// app.post('/uploadfile',upload.single("shubham") ,async (req, res) => {
//     const upload=multer({storage:storage})
//     try {
...
//         //     file: req
//         // })
//         // const { name, layer, parent, owner } = req.body;
//         // const uuid1 = uuid.v4();
//         // if (req.file) {
...
app.post('/uploadfile', async (req, res) => {
    try {
        ...
        const newfile = await pool.query("INSERT INTO files (identifier,name,layer,parent,owner,content) VALUES ($1,$2,$3,$4,$5) RETURNING *", [uuid1, name, layer + 1, parent, owner, content]);
        res.status(200).json(newfile.rows[0]);
    } catch (e) {
        console.error(e);
        res.status(500).send("Server Error");
